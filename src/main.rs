...
fn main() -> Result<(), eframe::Error> {
    ...
    eframe::run_native("LiveTL", options,
        Box::new(|cc| {
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            egui::SidePanel::left("left_panel")
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.add(egui::TextEdit::singleline(&mut state.stream_link).hint_text("https://www.youtube.com/watch?v=..."));
                ...
                .vertical(|mut strip| {
                    ...
                    strip.cell(|ui| {
                        ui.horizontal_centered(|ui| {
                            ...
                            state.video_corners = [ui.available_rect_before_wrap().expand(scale_factor * ctx.pixels_per_point()).min, ui.available_rect_before_wrap().expand(scale_factor * ctx.pixels_per_point()).max];  
                        });
                    });
                    strip.cell(|ui|{});
                })
...
fn handle_video_player(state: Arc::<Mutex::<State>>) {
    ...
    loop {
        ...
        mpv.set_property("geometry", format!("{}x{}+{}+{}", width, height, x, y)).unwrap();
